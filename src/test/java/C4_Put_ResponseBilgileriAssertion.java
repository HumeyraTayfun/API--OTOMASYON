...
public class C4_Put_ResponseBilgileriAssertion {
    ...
    public void pur01(){
        ...
        response.then().assertThat().statusCode(200).header("Server","cloudflare").contentType("application/json; charset=utf-8").statusLine("HTTP/1.1 200 OK");

        response.prettyPrint();//consolda görmek istersek
